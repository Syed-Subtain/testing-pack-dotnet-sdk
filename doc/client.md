...
## Enum as Template Parameter Example APIClient Class
...
| `ToBuilder()` | Creates an object of the Enum as Template Parameter Example APIClient using the values provided for the builder. | `Builder` |

## Enum as Template Parameter Example APIClient Builder Class

Class to build instances of Enum as Template Parameter Example APIClient.
