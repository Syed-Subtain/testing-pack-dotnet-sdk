...
using EnumAsTemplateParameterExampleAPI.Standard.Http.Request;
using EnumAsTemplateParameterExampleAPI.Standard.Http.Response;

namespace EnumAsTemplateParameterExampleAPI.Standard.Http.Client
{
    /// <summary>
